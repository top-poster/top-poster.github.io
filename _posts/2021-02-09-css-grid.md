...
<table><thead><tr><th>value</th><th>meaning</th><th>default</th></tr></thead><tbody><tr><td> row</td><td>Row along each row axis</td><td><code>`row`</code></td></tr><tr><td>column</td> <td>Place in turn along each column axis</td><td></td></tr><tr><td>row dense(dense)</td><td>Place in sequence along each row axis, empty
...
<table><thead><tr><th>value</th><th>meaning</th><th>default</th></tr></thead><tbody><tr><td> normal</td><td><code>same as `stretch`</code></td><td><code>`normal`</code></td></tr><tr><td>start</td><td>Align start point (top)</td><td></td></tr><tr><td>center</td><td>Align vertical center</td
...
>The first line is at the start point, the end line at the end point, and evenly aligned with the remaining margins</td><td></td></tr><tr><td>space-evenly</td><td> Align all margins evenly</td><td></td></tr><tr><td>stretch</td><td>stretch grid content to fill column axis</td><td><
 /td></tr></tbody></table>
```css
.container {
    width: 450px;
...
<table><thead><tr><th>value</th><th>meaning</th><th>default</th></tr></thead><tbody><tr><td> normal</td><td><code>same as `stretch`</code></td><td><code>`normal`</code></td></tr><tr><td>start</td><td>Align start point (left)</td><td></td></tr><tr><td>center</td><td>Align horizontal center</td
...
>First column at the start point, the end column at the end point, and evenly with the remaining margins</td><td></td></tr><tr><td>space-evenly</td><td> Align all margins evenly</td><td></td></tr><tr><td>stretch</td><td>stretch grid content to fill the row axis</td><td><
 /td></tr></tbody></table>
```css
.container {
    width: 450px;
...
<table><thead><tr><th>value</th><th>meaning</th><th>default</th></tr></thead><tbody><tr><td> same as normal</td><td><code>`stretch`</code></td><td><code>`normal`</code></td></tr><tr><td>start</td><td>Align start point (top)</td><td></td></tr><tr><td>center</td><td>Align vertical center</td
...
```xml
<div class="container"><header class="item">HEADER</header><main class="item">MAIN</main><aside class="item">ASIDE</aside><footer class="item">FOOTER</footer></div>
```
...
```xml
<div class="container"><div class="item">Minimum size of content</div><!-- ... --></div>
```
